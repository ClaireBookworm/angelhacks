...
- **Hacking‽ Is that safe?**
  No, we’re not “hacking” servers. The word is being constructively redefined for coding—apps, games, websites. It’s safe, supervised, & entirely educational.
...
- **Who runs this? Is it supervised?**
  We’re independently-organized by high schoolers, sponsored via a nonprofit called [Hack Club](https://hackclub.com/). It’s fully supervised by 20+ adult mentors & chaperones.
